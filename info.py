...
# Subscribe YouTube Channel For Amazing Bot @meankitsharmaa
# Ask Doubt on telegram @meankitsharmaa
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://meankitsharmaa:JpC176pId01q1mIi@cluster0.8efakhm.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "neha_filter_bot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'fhdteamcollection')
